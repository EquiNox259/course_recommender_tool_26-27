...
class LLMService:
    ...
    def rephrase_and_extract_intent(self, raw_query: str) -> dict:
        ...
        system_prompt = (
            ...
            "- Energy Science and Engineering: EN (energy science, energy engineering, en)\n"
            "- Environmental Science and Engineering: ES (environmental engineering, env, environmental, esed, es)\n"
            ...
            "AE, BB, CE, CS, CL, CH, DS, EC, EE, EN, ES, IE, MA, ME, MG, MM, PH, SOM, ENT, GNR, SI, SC.\n"
            "\n"
            ...
            "- Centre for Systems and Control (aliases: syscon, systems and control, sc)\n"
            ...
            "- Statistics (aliases: statistics, stats, si)\n"
            "- Chemistry (aliases: chemistry, chem, ch)\n"
            "- Economics (aliases: economics, eco, econ, ec)\n"
            "- Energy Science and Engineering (aliases: energy science, energy engineering, en)\n"
            "-Environmental Science and Engineering: ES (environmental engineering, env, environmental, esed, es)\n"
