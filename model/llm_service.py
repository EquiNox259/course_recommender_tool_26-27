...
class LLMService:
    ...
    def rephrase_and_extract_intent(self, raw_query: str) -> dict:
        ...
        system_prompt = (
            ...
            "Expand common abbreviations whenever possible (e.g. 'ML' -> 'machine learning', 'AI' -> 'artificial intelligence', 'NLP' -> 'natural language processing').\n\n"
            ...
            "- Computer Science: CS (computer science, comp sci, cs)\n"
            "- Mechanical Engineering: ME (mechanical, mech)\n"
            "- Metallurgical Engineering and Materials Science: MM (metallurgy, materials, material science, metallurgical)\n"
            "- Electrical Engineering: EE (electrical, elec, electronics)\n"
            "- Aerospace Engineering: AE (aerospace, aero, aeronautical)\n"
            "- Civil Engineering: CE (civil)\n"
            "- Chemical Engineering: CL (chemical, chem eng)\n"
            "- Chemistry: CH (chemistry, chem)\n"
            "- Engineering Physics / Physics: PH (physics, engineering physics)\n"
            "- Economics: EC (economics, econ, eco)\n"
            "- Energy Science and Engineering: EN (energy, energy science)\n"
            "- Environmental Science and Engineering: ES (environmental, environment, environmental science)\n"
            "- Biosciences and Bioengineering: BB (biology, bio, biosciences, bioengineering)\n"
            " - Data Science: DS (ds, data science, cminds, centre of machine intelligence and data science, centre of machine learning)\n"
            "\n"
            ...
            "1. combined: Every extracted concept, field, and structural modifier.\n"
